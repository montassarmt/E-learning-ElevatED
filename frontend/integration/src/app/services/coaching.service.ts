...
export class CoachingService {
  private apiUrl = 'http://localhost:8085/api/seances';
  ...
  updateSeance(id: number, seance: SeanceCoaching): Observable<SeanceCoaching> {
    return this.http.put<SeanceCoaching>(`${this.apiUrl}/${id}`, seance);
  }
}
